...
- [ ] i18n for Telegram messages: move bot command/help/link/unlink/notification copy out of hard-coded English strings, reuse the app locale system or define a backend-safe translation layer, and ensure Telegram messages resolve the correct user/chat language.
